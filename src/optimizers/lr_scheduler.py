...
class LinearWarmupCosineAnnealingLR(_LRScheduler):
    ...
    .. warning::
        It is recommended to call :func:`.step()` for :class:`LinearWarmupCosinseAnneanlingLR`
    ...
    .. warning::
        ...
        :func:`get_lr()`. Though this does not change the behavoir of the scheduler when passing
